...
2. **Ice Spikes Eruption (8 ทิศทาง ระยะ 10 บล็อก):**
   ...
   - ศัตรูที่ถูกหนามน้ำแข็งแทงจะได้รับดาเมจ 20 หน่วย (คำนวณตามพลังเวท Ice Spell Power) ควบคู่กับดีบัฟ Frostbite

## ค่าตัวเลขและการคำนวณ (Formulas & Scaling)
- **Damage:** 20 Base Damage (+3 ต่อเลเวลเวทมนตร์) สเกลตาม Ice Spell Power ของผู้ร่าย
