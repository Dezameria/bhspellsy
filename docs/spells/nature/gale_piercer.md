...
- Sounds:
  ...
  - Charge Complete (10s): Level up sound and wind surge (`SoundEvents.PLAYER_LEVELUP`, `SoundEvents.BEACON_ACTIVATE`)
...
1. When casting begins, the caster enters the bow-charging stance.
...
## Releasing and charge stages

- Releasing before 200 ticks (10 seconds) executes an **Early Release**:
...
- Holding the charge for 200 ticks (10 seconds) enters **Full Charge — “ศรวายุ”**:
  - The player receives visual/audio confirmation of full charge. The charge can be held until released.
