...
public class GlacialSpikeRenderer extends EntityRenderer<GlacialSpikeEntity> {

    private final GlacialSpikeModel model;

    public GlacialSpikeRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new GlacialSpikeModel(pContext.bakeLayer(GlacialSpikeModel.LAYER_LOCATION));
    }

    @Override
    public void render(GlacialSpikeEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource multiBufferSource, int light) {
    ...
    @Override
    public ResourceLocation getTextureLocation(GlacialSpikeEntity pEntity) {
        return IronsSpellbooks.id("textures/entity/ice_spike.png");
    }

    public static class GlacialSpikeModel extends EntityModel<GlacialSpikeEntity> {
        public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(IronSpellMore.MODID, "glacial_spike"), "main");
        private final ModelPart bottom;
        private final ModelPart middle;
        private final ModelPart top;

        public GlacialSpikeModel(ModelPart root) {
        ...
        @Override
        public void setupAnim(GlacialSpikeEntity entity, float partialTicks, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            float scale = entity.getSpikeSize();
            top.visible = false;
